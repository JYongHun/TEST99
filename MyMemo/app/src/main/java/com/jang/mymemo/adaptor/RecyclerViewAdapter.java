package com.jang.mymemo.adaptor;
...
import com.jang.mymemo.AddMemo;
import com.jang.mymemo.MainActivity;
import com.jang.mymemo.R;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public RecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.draw_memo, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerViewAdapter.ViewHolder holder, int position) {
        ...
        String phone = contact.getContent();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            txtPhone = itemView.findViewById(R.id.txtContent);
            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i = new Intent(context, AddMemo.class);
